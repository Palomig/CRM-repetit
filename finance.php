...
<div x-data="financeApp()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 space-y-4 sm:space-y-0">
        <div>
            ...
            <p class="text-gray-600 mt-1">Учет доходов и расходов</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
            ...
            <select x-model="filters.month" @change="loadData()" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            ...
            <select x-model="filters.year" @change="loadData()" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600 mt-2" x-text="formatMoney(stats.summary?.total_income || 0)"></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Расход</p>
                    <p class="text-3xl font-bold text-red-600 mt-2" x-text="formatMoney(stats.summary?.total_expense || 0)"></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Прибыль</p>
                    <p class="text-3xl font-bold mt-2" 
                       :class="(stats.summary?.profit || 0) >= 0 ? 'text-green-600' : 'text-red-600'"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-bold text-gray-900 mb-4">По категориям</h3>
            <canvas id="categoryChart"></canvas>
        </div>

        <!-- График по предметам -->
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-bold text-gray-900 mb-4">Доход по предметам</h3>
            <canvas id="subjectChart"></canvas>
        </div>

        <!-- График динамики -->
        <div class="bg-white rounded-lg shadow p-6 lg:col-span-2">
            <h3 class="text-lg font-bold text-gray-900 mb-4">Динамика доходов и расходов</h3>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-900">Транзакции</h3>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <template x-for="transaction in transactions" :key="transaction.id">
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="formatDate(transaction.transaction_date)"></td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button @click="deleteTransactionConfirm(transaction.id)" class="text-red-600 hover:text-red-900">
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-xl font-bold text-gray-900">Добавить транзакцию</h3>
                ...
                <form @submit.prevent="saveTransaction">
                    <div class="space-y-4">
                        <div>
                            ...
                            <select x-model="form.type" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <select x-model="form.category" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="number" x-model="form.amount" step="0.01" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Дата *</label>
                            <input type="date" x-model="form.transaction_date" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        </div>

                        <div x-show="form.type === 'income'">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Ученик</label>
                            <select x-model="form.student_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <textarea x-model="form.description" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></textarea>
                        </div>
                    </div>
